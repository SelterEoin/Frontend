...
var ContextMenu = function ContextMenu(menu_items) {
    ...
    return function (ChildComponent) {
        var Container = function (_React$Component) {
            ...
            Container.prototype.clean = function clean() {
                this.clickable_elements = _underscore2.default.filter(this.clickable_elements, function (element) {
                    return element !== null;
                });
            };

            Container.prototype.rebind = function rebind() {
                var _this2 = this;
            ...
            Container.prototype.cleanAndRebind = function cleanAndRebind() {
                this.clean();
                this.rebind();
            };
